...
/**
 * This class is acting as a custom exception, created for the application.
 * 
 * @author sagarwal
 *
 */
public class CustomApplicationException extends RuntimeException implements CustomException {
	...
	public CustomApplicationException(String message, Throwable cause, boolean enableSuppression,
